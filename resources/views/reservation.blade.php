		...
		<form id="reserved_form">
			...
			<div>
				<div>
					<font>
						[任意]予約時入力欄</br>
						　駐車場オーナーの方への伝言がございましたら入力ください。
					</font>
				</div>
				<div>
					<TEXTAREA id="free_area" cols="40" rows="3" wrap="hard"></TEXTAREA>
				</div>
			</div>
			</br>
			<div id="purpose_div">
				<div id="purpose_title_div">
					<font>駐車場利用目的を選択してください。</font>
				</div>
				<div id="purpose_input_div">
					<input type="radio" name="example" value="1" checked>観光
					</br>
					<input type="radio" name="example" value="2">買い物
					</br>
					<input type="radio" name="example" value="3">通勤・通学
					</br>
					<input type="radio" name="example" value="4">海水浴
					</br>
					<input type="radio" name="example" value="5">マリンスポーツ
					</br>
					<input type="radio" name="example" value="6">イベント・コンサート
					</br>
					<input type="radio" name="example" value="7">送迎
					</br>
					<input type="radio" name="example" value="8">習い事
					</br>
					<input type="radio" name="example" value="9">友人知人宅訪問
					</br>
					<input type="radio" name="example" value="10">工事・建築
					</br>
					<input type="radio" name="example" value="11">配送・配達
					</br>
					<input type="radio" name="example" value="12">営業・取引先訪問
					</br>
					<input type="radio" name="example" value="13">役務提供
					</br>
					<input type="radio" name="example" value="99">その他
					</br>
					<TEXTAREA id="othere_area" cols="40" rows="3" wrap="hard"></TEXTAREA>
				</div>
			</div>
			</br>
			<div id="move_botton_div">
				<input type="button" id="returnPage" value="前へ戻る" onclick="rePage()">
				<input type="button" id="nextPage" value="予約確定" onclick="insertPage()"></br>
			</div>
		</form>
		</br>
		<form id="footer_form">
